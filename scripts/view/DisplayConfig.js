...
export function DisplayConfig() {
  ...
  <div id="config_section">
    <div class="div_switch">
      <p id="config_delete-permanently-p">Confirmar antes de borrar notas de la papelera</p>
    ...
    <div class="div_switch">
      <p id="config_delete-permanently-selection-p">Confirmar antes de borrar las notas seleccionadas de la papelera</p>
    ...
    <div class="div_switch">
      <p id="config_move-to-trash-p">Mostrar opción para deshacer después de mover una nota</p>
    ...
    <div class="div_switch">
      <p id="config_empty-note-p">Confirmar antes de borrar una nota vacía</p>
